...
각 관측값에는 제품 등급, 공기 및 공정 온도, 회전 속도, 토크, 공구 마모 시간과 함께 설비 고장 여부 및 고장 유형이 기록되어 있습니다. 따라서 **설비 상태 조회 (Monitoring)**, **고장 위험 분류 (Classification)**, **이상 조건 탐색 (Anomaly Detection)**과 같은 예지보전 시나리오에 활용할 수 있습니다.

데이터 파일은 [`data/ai4i2020.csv`](data/ai4i2020.csv)에 있습니다.
